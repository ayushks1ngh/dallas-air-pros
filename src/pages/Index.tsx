...
const Index = () => (
  <>
    <SEO title="24/7 Emergency HVAC Service" description="Expert heating, cooling, and air quality solutions for homes and businesses across the Dallas-Fort Worth metroplex. Licensed, insured, 20+ years experience." path="/" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-wrap gap-4">
              <a href={BUSINESS.phoneHref} className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-opacity">
                <Phone className="w-5 h-5" aria-hidden="true" /> {BUSINESS.phone}
              </a>
              <Link to="/contact" className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-lg font-bold text-lg hover:opacity-90 transition-opacity">
                Get Free Quote
              </Link>
            </div>
          </div>
          <div className="hidden lg:block">
            <QuoteForm sourcePage="homepage" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 md:py-24 bg-muted">
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-foreground">Professional HVAC Solutions</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((s) => (
            <Link key={s.title} to={s.to} className="group bg-card rounded-xl overflow-hidden shadow-sm border border-border hover:shadow-lg transition-shadow">
    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-foreground">What Our Customers Say</h2>
        </div>
    ...
    <section className="py-16 md:py-24 bg-secondary">
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="font-heading font-extrabold text-3xl md:text-4xl text-foreground">Proudly Serving the DFW Metroplex</h2>
        </div>
        ...
        <div className="text-center mt-8">
          <Link to="/service-areas" className="text-primary font-semibold hover:underline">View All Service Areas →</Link>
        </div>
      </div>
    </section>
    ...
    <section className="lg:hidden bg-muted py-16">
      <div className="container max-w-xl">
        <QuoteForm sourcePage="homepage-mobile" />
      </div>
    </section>
